...
func (a *Analyzer) buildDockerImage(ctx context.Context, cli *client.Client, imageName string) (image.BuildResponse, error) {
	return cli.ImageBuild(ctx, nil, image.BuildOptions{
